...
public class AsciiPanel extends JPanel {
    ...
    public static final Color research = new Color(9, 132, 125);
    public static final Color industry = new Color(102, 66, 11);

    public static final Color terraforming = new Color(37, 139, 42);

    public static final Color shipbuilding = new Color(97, 6, 6);

    public static final Color defense = new Color(92, 12, 109);
     ...
     */
    public static Color white = new Color(120, 120, 120);
    ...
    public void paintLine(int x, int y, int x2, int y2) {
        ...
        offscreenGraphics.drawLine(x, y, x2, y2);
    }
    @Override
