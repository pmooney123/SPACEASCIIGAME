...
public class Fleet {
    ...
    public Fleet(Civ ownerCiv, Star currentStar, int power, Star starTarget, boolean colonyShip, int population, Planet destPlanet) {
        ...
        this.destinationPlanet = destPlanet;
    }
